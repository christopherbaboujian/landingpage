module.exports = {
  ...
  popups: [
    ...
    {
      type: 'type2',
      title: "Wat is je voorkeur?",
      description: '',
      options: [
        '',
        'Powder: Ik voeg graag zelf water toe en mix het drankje zelf',
        'Ready to Drink: Ik wil het product graag klaar hebben om te drinken',
      ],
      buttonTitle: 'Volgende',
    },
    {
    ...
    {
      type: 'type4',
      title: 'Dank je wel, je krijgt straks een bevestigingsmail toegestuurd.',
